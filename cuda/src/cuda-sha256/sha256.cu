...
#else
static __host__ __device__ int sha256_compress(hash_state * md, const unsigned char *buf)
#endif
{
...
*/
inline __host__ __device__ int sha256_init(hash_state * md)
{
    LTC_ARGCHK(md != NULL);
...
/**
   ...
   @return CRYPT_OK if successful
*/
inline __host__ __device__ int sha256_done(hash_state * md, unsigned char *out)
{
    int i;
